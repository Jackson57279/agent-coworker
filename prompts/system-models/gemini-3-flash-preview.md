...
Prefer dedicated tools. Use absolute paths. Quote paths with spaces. Run independent commands in parallel. For dependent commands, use platform-appropriate sequencing or separate tool calls. For pip: --break-system-packages.
