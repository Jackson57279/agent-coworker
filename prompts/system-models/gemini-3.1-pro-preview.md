...
- For the Google provider in this app, webSearch is Exa-backed. If credentials are missing, ask the user to save an Exa API key in provider settings (Google -> Exa API key) or set `EXA_API_KEY`.
</webSearch>
