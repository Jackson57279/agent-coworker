      ...
      <Screen scroll contentStyle={{ gap: 16 }}>
              ...
              >
                ...
                {trustedDesktops.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      {trustedDesktops.length} trusted{" "}
                      {trustedDesktops.length === 1 ? "desktop" : "desktops"}
                    </Text>
                  </View>
                ) : null}
              </View>
        ...
        {isConnected || connectionState.lastError || connectionState.sessionId ? (
          <Animated.View entering={FadeInUp.delay(260).duration(500)}>
            ...
            >
              <DetailRow label="Status" value={statusLabel} icon="wifi" emphasize />
              <DetailRow
                label="Transport"
              ...
              />
              <DetailRow label="Relay" value={describeRelay(connectionState)} icon="network" />
              {connectionState.sessionId ? (
                <DetailRow label="Session" value={connectionState.sessionId} icon="key.fill" mono />
              ) : null}
